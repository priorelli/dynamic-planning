...
# Define unit class
class Unit:
    def __init__(self, dim, inputs, pi_eta_x, pi_x,
                 lr, f, lmbda, g=None):
        # Point to inputs
        self.inputs = inputs
        ...
        # Initialize learning rate and gain
    ...
    def update(self, dt):
        ...
        dF_dx += self.eps_eta_x
        for grad_o in self.grad_o:
            dF_dx += grad_o
        dF_dx[0] += self.grad_x
        dF_dx[1] += self.eps_x
